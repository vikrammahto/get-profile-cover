...
export const useDraggableText = (
  ...
  const handleMouseDown = useCallback((e) => {
    ...
    const nameDistance = Math.hypot(x - state.namePosition.x, y - state.namePosition.y);
    const titleDistance = Math.hypot(x - state.titlePosition.x, y - state.titlePosition.y);
